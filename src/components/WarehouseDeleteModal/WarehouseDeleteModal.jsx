...
const WarehouseDeleteModal = ({ isOpen, onClose, onDelete, itemName }) => {
  return (
    <ReactModal
      isOpen={isOpen}
    ...
    >
      <div className="delete-modal__header">
        <h2 className="delete-modal__title">Delete {itemName} warehouse?</h2>
        <button className="delete-modal__close-button" onClick={onClose}>
          <img src={closeIcon} alt="Close" />
        </button>
      </div>
      <p className="delete-modal__message">
        Please confirm that you’d like to delete {itemName} from the list of warehouses. You won’t be able to undo this action.
      </p>
